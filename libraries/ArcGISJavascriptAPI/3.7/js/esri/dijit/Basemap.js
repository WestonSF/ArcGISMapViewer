...
a.title||"";this.thumbnailUrl=a.thumbnailUrl;this.basemapGallery=l},getLayers:function(){if(this.layers)return this.layers;if(this.itemId){var a=h({url:e.dijit._arcgisUrl+"/content/items/"+this.itemId+"/data",content:{f:"json"},callbackParamName:"callback",error:d.hitch(this,function(a,c){if(this.basemapGallery)this.basemapGallery.onError("esri.dijit.Basemap: could not access basemap item.");else console.error("esri.dijit.Basemap: could not access basemap item.")})});a.addCallback(d.hitch(this,function(a,
c){if(a.baseMap)return this.layers=[],f.forEach(a.baseMap.baseMapLayers,function(a){var b={};a.url&&(b.url=a.url);a.type&&(b.type=a.type);a.isReference&&(b.isReference=a.isReference);a.displayLevels&&(b.displayLevels=a.displayLevels);a.visibleLayers&&(b.visibleLayers=a.visibleLayers);a.bandIds&&(b.bandIds=a.bandIds);this.layers.push(new k(b))},this),this.layers;if(this.basemapGallery)this.basemapGallery.onError("esri.dijit.Basemap: could not access basemap item.");else console.error("esri.dijit.Basemap: could not access basemap item.");
return[]}));return a}}});g("extend-esri")&&d.setObject("dijit.Basemap",c,e);return c});