...
define("esri/dijit/analysis/AnalysisToolItem","require dojo/_base/declare dojo/_base/lang dojo/_base/connect dojo/_base/event dojo/has dojo/dom-class dojo/dom-attr dojo/dom-style dijit/_WidgetBase dijit/_TemplatedMixin dijit/_OnDijitClickMixin dijit/_FocusMixin esri/kernel dojo/text!esri/dijit/analysis/templates/AnalysisToolItem.html".split(" "),function(b,f,d,s,g,h,c,k,e,l,m,n,p,q,r){b=f([l,m,n,p],{declaredClass:"esri.dijit.analysis.AnalysisToolItem",templateString:r,basePath:b.toUrl("esri/dijit/analysis"),
widgetsInTemplate:!0,i18n:null,_helpIconNode:null,_toolIcon:null,_toolIconClass:null,_toolNameLabel:null,toolName:null,helpTopic:null,helpFileName:"Analysis",constructor:function(a,b){a.toolIcon&&(this._toolIconClass=a.toolIcon);a.name&&(this.toolName=a.name,this.helpTopic=a.helpTopic)},postCreate:function(){this.inherited(arguments);this._toolNameLabel.innerHTML=this.toolName;c.add(this._toolIcon,this._toolIconClass);k.set(this._helpIconNode,"esriHelpTopic",this.helpTopic);this.set("showComingSoonLabel",
!0)},postMixInProperties:function(){this.inherited(arguments);this.i18n={};d.mixin(this.i18n,dojo.i18n.getLocalization("esri","jsapi").common);d.mixin(this.i18n,dojo.i18n.getLocalization("esri","jsapi").analysisTools)},_handleToolNameClick:function(){this.onToolSelect(this)},_handleToolIconClick:function(a){g.stop(a);this.onToolSelect(this)},_setShowComingSoonLabelAttr:function(a){e.set(this.optionsDiv,"display",!0===a?"block":"none");c.toggle(this._toolCtr,"esriToolContainerDisabled",a);c.toggle(this._toolNameLabel,
"esriTransparentNode",a);c.toggle(this._toolIcon,"esriTransparentNode",a);e.set(this._toolNameLabel,"cursor",!0===a?"default":"pointer");e.set(this._toolCtr,"cursor",!0===a?"default":"pointer")},onToolSelect:function(a){}});h("extend-esri")&&d.setObject("dijit.analysis.AnalysisToolItem",b,q);return b});