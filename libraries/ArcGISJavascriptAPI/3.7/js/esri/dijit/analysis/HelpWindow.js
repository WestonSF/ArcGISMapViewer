...
(this.showLearnMore=!0,d="http://resources"+e+".arcgis.com/en/help/arcgisonline/#/"+this.onlineHelpMap[this.helpFileName][a]);-1!==dojo.indexOf("ar da de es fr it ja ko ru nl no pl pt-br pt-pt ro sv zh-cn".split(" "),b)&&(-1!==b.indexOf("-")&&(f=b.split("-"),b=f[0]+"-"+f[1].toUpperCase()),f=c+"/js/esri/dijit/analysis/help/"+b+"/"+this.helpFileName+".html",this.showLearnMore&&(d="http://resources"+e+".arcgis.com/"+b+"/help/arcgisonline/#/"+this.onlineHelpMap[this.helpFileName][a]));c=this._computeSize(a);
this.tooltipHelpDlg=new r({preload:!0,content:"\x3cdiv class\x3d'' style\x3d'position\x3drelative'\x3cdiv class\x3d'sizer content'\x3e\x3cdiv class\x3d'contentPane'\x3e\x3cdiv class\x3d'esriFloatTrailing' style\x3d'padding:0;'\x3e\x3ca href\x3d'#' onclick\x3d'esri.dijit._helpDialog.close()' 'title\x3d'"+this.i18n.close+"'\x3e\x3cimg src\x3d'images/close.gif' border\x3d'0'/\x3e\x3c/a\x3e\x3c/div\x3e\x3ciframe frameborder\x3d'0'  id\x3d'"+a+"' src\x3d'"+f+"#"+a+"' width\x3d'"+c.w+"' height\x3d'"+c.h+
"' marginheight\x3d'0' marginwidth\x3d'0'\x3e\x3c/iframe\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d'sizer'\x3e\x3cdiv class\x3d'actionsPane'\x3e\x3cdiv class\x3d'actionList"+(this.showLearnMore?"'\x3e":" hidden'\x3e")+"\x3ca class\x3d'action zoomTo' href\x3d'"+(this.showLearnMore?d:"#")+"' target\x3d'_help'\x3e"+this.i18n.learnMore+"\x3c/a\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e","class":"esriHelpPopup esriHelpPopupWrapper"})},show:function(a,b){this.helpFileName=b.helpFileName;
this._analysisGpServer=b.analysisGpServer;this.set("helpTopic",b.helpId);g.open({popup:this.tooltipHelpDlg,x:!0===this._isRightToLeft?a.pageX-40:a.pageX+40,y:a.screenY-a.pageY+10,onExecute:function(){g.close(this.tooltipHelpDlg)}})},close:function(a,b){g.close(this.tooltipHelpDlg)}});p("extend-esri")&&e.setObject("dijit.analysis.HelpWindow",d,s);return d});