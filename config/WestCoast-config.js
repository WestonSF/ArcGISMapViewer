        ...
        identifyParams: [
...

                        {
                            ...
                            identifyLayerAliases: [ // ids must not contain spaces // name = map service layer name // TODO - tabindex is repeated.  This could be moved into an array where it is not repeated.
                                ...
                                { tabName: "Discharge Consent", tabindex: 3, layerName: "Discharge", displayFormat: "<B>Type: [#Type#] <br/> Subtype: [#Subtype#]</B> <br/><br/> Purpose: [#Purpose#] <br/> Activity: [#Activity#] <br/> Status: [#Status#] <br/> Authority Number: [#Auth_no#]" },
                                ...
                                { tabName: "Water Consent", tabindex: 4, layerName: "Water", displayFormat: "<B>Type: [#Type#] <br/> Subtype: [#Subtype#]</B> <br/><br/> Purpose: [#Purpose#] <br/> Activity: [#Activity#] <br/> Status: [#Status#] <br/> Authority Number: [#Auth_no#]" }
                            ]
                        },
                        ...
                        },
                        {
                            ...
                            layerOption: esri.tasks.IdentifyParameters.LAYER_OPTION_VISIBLE, // LAYER_OPTION_VISIBLE, LAYER_OPTION_TOP or LAYER_OPTION_ALL
                            identifyLayerAliases: [ // ids must not contain spaces // name = map service layer name // TODO - tabindex is repeated.  This could be moved into an array where it is not repeated.
                                { tabName: "Parcel", tabindex: 3, layerName: "Parcel", displayFormat: "<B>Parcel ID: [#PAR_ID#]</B> <br/><br/> Type: [#FEATCODE#] <br/> Intent: [#PARCEL_INTENT#] <br/> Area: [#PARCEL_AREA#]" }
                            ]
                        },
                        {
                            id: "PropertySAHS",
